defmodule phoebeWeb.Errors do
  alias Ecto.Changeset
  alias phoebeWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(phoebe.Gettext, "ecto", message, message, options[:count], options)
    else
      Gettext.dgettext(phoebe.Gettext, "ecto", message, options)
    end
  end
